...
- **Integration Ecosystem:** Client-facing page showing 124+ platforms across 12 segments (GDS, NDC Airlines, IATA/BSP, Hotels Global, Hotels Brazil/FOHB, Car Rental, Consolidators, Tour Operators, Insurance, Payments, TMC/OBT, Events/MICE). Collapsible segments with search, integration methods per segment. Documented in contract as M10 and E22.
