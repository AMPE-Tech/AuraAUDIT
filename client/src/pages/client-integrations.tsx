...
const ECOSYSTEM: EcosystemSegment[] = [
  ...
  },
  {
    id: "tmc-global",
    name: "TMC Globais",
    subtitle: "Travel Management Companies com operacao no Brasil",
    icon: Globe,
    iconColor: "text-cyan-500",
    platforms: [
      { name: "American Express GBT (Amex GBT)", type: "api" },
      { name: "BCD Travel", type: "api" },
      { name: "CWT (Carlson Wagonlit Travel)", type: "api" },
      { name: "FCM Travel (Flight Centre)", type: "api" },
      { name: "Corporate Travel Management (CTM)", type: "api" },
      { name: "Egencia (American Express)", type: "api" },
    ],
    integrationMethods: ["API privada", "SFTP", "CSV/XLSX", "Portal corporativo"],
  },
  {
    id: "tmc-brasil",
    name: "TMC Nacionais (ABRACORP)",
    subtitle: "Agencias corporativas brasileiras",
    icon: Users,
    iconColor: "text-blue-400",
    platforms: [
      { name: "Flytour Business Travel", type: "api" },
      { name: "Avipam Viagens Corporativas", type: "api" },
      { name: "Alatur JTB", type: "api" },
      { name: "Costa Brava Travel", type: "api" },
      { name: "Kontik Business Travel", type: "api" },
      { name: "Grupo Arbaitman (Maringa Turismo)", type: "api" },
      { name: "Reserve Travel", type: "api" },
      { name: "Hostway Travel", type: "api" },
      { name: "Copastur", type: "api" },
      { name: "VoeTur", type: "api" },
      { name: "SAP Concur", type: "api" },
      { name: "ExpenseOn", type: "api" },
      { name: "TMS Travel", type: "api" },
    ],
    integrationMethods: ["API privada", "SFTP", "CSV/XLSX", "Arquivo mensal"],
  },
  {
    id: "events-agencies",
    name: "Agencias de Eventos (MICE)",
    subtitle: "Especializadas em eventos corporativos, incentivos e convencoes",
    icon: CalendarDays,
    iconColor: "text-rose-500",
    platforms: [
      { name: "MCI Brasil", type: "api" },
      { name: "Alatur Eventos", type: "api" },
      { name: "Flytour Eventos", type: "api" },
      { name: "Sherpa42", type: "api" },
      { name: "TM1 Eventos", type: "api" },
      { name: "SRCOM", type: "api" },
      { name: "Banco de Eventos", type: "api" },
      { name: "Holding Clube", type: "api" },
      { name: "Agencia Samba", type: "api" },
      { name: "BFerraz", type: "api" },
    ],
    integrationMethods: ["API privada", "Portal", "CSV/XLSX", "Arquivo de evento"],
  },
  {
    id: "traveltech",
    name: "TravelTech Corporativas",
    subtitle: "Plataformas digitais que estao transformando o setor",
    icon: Wifi,
    iconColor: "text-purple-500",
    platforms: [
      { name: "Onfly", type: "api" },
      { name: "Paytrack Travel", type: "api" },
  ...
  },
  {
    ...
    subtitle: "Sistemas de gestao e ticketing de eventos",
    icon: Ticket,
    iconColor: "text-amber-400",
    platforms: [
      { name: "Sympla", type: "api" },
