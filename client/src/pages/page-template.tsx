        ...
        <Card data-testid="section-hero">
          <CardContent className="p-6 space-y-4">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed max-w-3xl">
              Descrição do conteúdo desta página. Explique o valor e propósito do módulo/produto.
            </p>
          ...
          <Card>
            <CardContent className="p-6 space-y-3">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Conteúdo da seção. Adicione quantas seções forem necessárias.
                Cada seção deve ter um id único para navegação via topbar.
              </p>
            </CardContent>
          </Card>
        </section>
