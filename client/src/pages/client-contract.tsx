...
const CONTRACT_DATA = {
  ...
  deliverables: [
    { name: "Relatorio Executivo de Auditoria", deadline: "A cada fase concluida", status: "em_andamento" },
    { name: "Relatorio Tecnico Detalhado", deadline: "Ao final do projeto", status: "pendente" },
    { name: "Matriz de Riscos e Anomalias", deadline: "Fase 03 - Reconciliacao", status: "em_andamento" },
    ...
    { name: "Dashboard Interativo de Resultados", deadline: "Disponivel em tempo real", status: "concluido" },
    { name: "Cadeia de Custodia Digital Completa", deadline: "Continuo durante o projeto", status: "em_andamento" },
  ],
  sla: [
