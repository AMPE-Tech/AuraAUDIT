...
const CATEGORIES: LatamCategory[] = [
  ...
  },
  {
    ...
    providers: ["CVC Corp", "Flytour", "BRT Operadora", "Copastur", "Rextur Advance", "Alatur JTB", "Avipam", "Travelcare", "Abracorp (associados)"],
  },
  {
    id: "midbackoffice",
  ...
  },
  {
    ...
    providers: ["Bradesco EBTA", "Itau Empresas", "Santander Corporate", "B2 Payments", "WEX", "AirPlus", "Conferma Pay", "Stripe"],
  },
  {
    id: "airlines",
    ...
    <div className="p-6 space-y-6 max-w-[1400px] mx-auto">
      ...
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-lg font-semibold" data-testid="text-categories-section-title">
          10 Categorias do Ecossistema
        </h2>
        <Badge variant="secondary" className="text-xs">10 categorias</Badge>
      </div>
