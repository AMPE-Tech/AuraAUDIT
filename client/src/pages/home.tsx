      ...
      <Card className="border-primary/20 bg-gradient-to-r from-primary/5 via-transparent to-transparent">
        <CardContent className="p-6 space-y-4">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed max-w-4xl">
            ...
            <span className="font-medium text-foreground">IAs Generativas altamente treinadas e supervisionadas por humanos</span> que detecta desconformidades e desperdicios em{" "}
            <span className="font-medium text-foreground">despesas corporativas</span>. A plataforma automatiza a coleta e a conciliacao de evidencias e entrega{" "}
